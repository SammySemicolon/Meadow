...
public class AspenTreeFeature extends AbstractCalcifiedTreeFeature<AspenTreeFeatureConfiguration> {

    public AspenTreeFeature() {
    ...
    public boolean place(FeaturePlaceContext<AspenTreeFeatureConfiguration> context, LodestoneBlockFiller filler) {
        ...
        var partiallyCalcifiedLogState = config.getPartiallyCalcifiedLog().defaultBlockState().trySetValue(PartiallyCalcifiedLogBlock.AXIS, Direction.Axis.Y);
