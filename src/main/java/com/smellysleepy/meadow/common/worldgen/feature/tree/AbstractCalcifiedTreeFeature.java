...
public abstract class AbstractCalcifiedTreeFeature<T extends AbstractCalcifiedTreeFeatureConfiguration> extends AbstractTreeFeature<T> {
    ...
    public AbstractCalcifiedTreeFeature(Codec<T> pCodec) {
        super(pCodec);
    }
...
//            }
    ...
    public abstract boolean place(FeaturePlaceContext<T> context, LodestoneBlockFiller filler);
}