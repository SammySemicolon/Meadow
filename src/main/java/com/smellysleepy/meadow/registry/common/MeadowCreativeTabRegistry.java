...
public class MeadowCreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MEADOW_GROVE = CREATIVE_MODE_TABS.register("meadow_grove",
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MINERAL_FLORA = CREATIVE_MODE_TABS.register("mineral_flora",
            () -> CreativeModeTab.builder()
