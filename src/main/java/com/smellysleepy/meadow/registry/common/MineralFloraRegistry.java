...
public class MineralFloraRegistry {
    ...
    public static final MineralFloraRegistryBundle AMETHYST_FLORA = register("amethyst", MeadowMobEffectRegistry.AMETHYST_FRUIT_EFFECT, new Color(254, 203, 230), Blocks.AMETHYST_BLOCK, Tags.Blocks.STORAGE_BLOCKS_AMETHYST);
    ...
    public static MineralFloraRegistryBundle register(ResourceLocation id, ResourceKey<ConfiguredFeature<?, ?>> key, Supplier<MobEffect> effect, Color color, Block ore, TagKey<Block> tag) {
        var bundle = new MineralFloraRegistryBundle(id, key, effect, color, ore, tag);
